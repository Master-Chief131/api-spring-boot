...
@IdClass(FacwebPrefacturaId.class)
public class FacwebPrefactura implements Serializable {
    ...
    public Date getFechaPrefactura() { return fechaPrefactura; }
    public void setFechaPrefactura(Date fechaPrefactura) { this.fechaPrefactura = fechaPrefactura; }
    ...
    public Date getFechaFacturo() { return fechaFacturo; }
    public void setFechaFacturo(Date fechaFacturo) { this.fechaFacturo = fechaFacturo; }
