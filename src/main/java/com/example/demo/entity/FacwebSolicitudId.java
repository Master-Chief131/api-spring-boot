...
public class FacwebSolicitudId implements Serializable {
    private Integer noCia;
    private Integer noSolicitud;

    public FacwebSolicitudId() {}

    public FacwebSolicitudId(Integer noCia, Integer noSolicitud) {
        this.noCia = noCia;
    ...
    public boolean equals(Object o) {
        ...
        FacwebSolicitudId that = (FacwebSolicitudId) o;
