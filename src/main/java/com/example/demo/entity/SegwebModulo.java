...
public class SegwebModulo implements Serializable {
    ...
    @Column(name = "ruta_visualizacion", length = 150)
    ...
    public String getValidaSeguridadMenu() {
        return validaSeguridadMenu;
    }

    public void setValidaSeguridadMenu(String validaSeguridadMenu) {
        this.validaSeguridadMenu = validaSeguridadMenu;
    }

    public String getValidaSeguridadNaf() {
        return validaSeguridadNaf;
    }

    public void setValidaSeguridadNaf(String validaSeguridadNaf) {
        this.validaSeguridadNaf = validaSeguridadNaf;
    }
    ...
    public void setContaComp(String contaComp) {
